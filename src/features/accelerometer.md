 ...
 * `Line 15` shows how to print in serial. To findout more about activating virtual serial on the Bean and viewing it on the Arduino IDE, checkout this tutorial [Using Serial](#)
